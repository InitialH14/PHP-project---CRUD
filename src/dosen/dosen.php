...
if (isset($_POST["submit"])) {
    ...
    $nama = $_POST["nama"];
    $prodi = $_POST["prodi"];
    $query2 = "INSERT INTO dosen(nidn, nama, prodi) VALUES ('$nidn', '$nama', '$prodi')";
...
<body>
    ...
    <div class="new_project_section layout_padding">
        <h1 class="w-100 mb-5 new_project_taital text-center">Daftar Dosen</h1>
        <div class="container section_list">
            ...
            $query = "SELECT * FROM dosen LIMIT $startFrom, $recordsPerPage";
            ...
            while ($data = mysqli_fetch_array($result)) {
                ...
                echo "<td style='text-align:center'><a href='edit-dosen.php?nidn=$data[nidn]' class='btn btn-warning btn-sm title='edit'><b>Edit</b></a>" .
                    "<a href='delete-dosen.php?nidn=$data[nidn]' class='btn btn-danger btn-sm' title='hapus' style='margin-left:10px'><b>Hapus</b></a>
                </td></tr>";
                $no++;
            }
            echo '</tbody>';
