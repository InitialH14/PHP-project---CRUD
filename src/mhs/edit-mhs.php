...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2" href="mhs.php">Data Mahasiswa</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="new_project_section layout_padding">
        <center>
            <h1 class="w-100 mb-5 new_project_taital text-center">Edit Profil Mahasiswa</h1>
        </center>
        <br>
        <div class="row justify-content-md-center">
            <div class="col-6">
                ...
                $nim = $_GET['nim'];
                $hasil = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE nim=$nim");
                ...
                <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                    ...
                    <button type="button" name="batal" onclick="location.href='mhs.php'"
...
if (isset($_POST["update"])) {
    ...
    $query = "UPDATE mahasiswa SET nim='$nim', nama='$nama', prodi='$prodi' WHERE nim='$nim'";
